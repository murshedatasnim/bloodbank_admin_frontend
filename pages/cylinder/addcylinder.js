...
export default function AddCylinder({ divisions}) {
    ...
    function onSubmit(data) {
        ...
        console.log(data);
        axios.post('http://absb.herokuapp.com/api/cylinder/',
            data,{headers: {
            'Content-Type': 'application/json',
            'x-auth-token': window.localStorage.getItem('x-auth-token')
        }})
    ...
    return (
        <Layout auth={auth}>
            ...
            <div className="card m-3">
                <h5 className="card-header">Enter New Oxygen Cylinder Data</h5>
